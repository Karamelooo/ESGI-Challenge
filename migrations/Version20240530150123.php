 ...
 */
final class Version20240530150123 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE "user" ADD last_connection_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL');
