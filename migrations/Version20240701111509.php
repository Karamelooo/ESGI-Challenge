 ...
 */
final class Version20240701111509 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE client (id INT NOT NULL, compagny_id INT DEFAULT NULL, company VARCHAR(255) NOT NULL, firstname VARCHAR(255) DEFAULT NULL, lastname VARCHAR(255) DEFAULT NULL, email VARCHAR(255) NOT NULL, phone VARCHAR(255) DEFAULT NULL, address VARCHAR(255) DEFAULT NULL, city VARCHAR(255) DEFAULT NULL, zip_code VARCHAR(255) DEFAULT NULL, siret INT DEFAULT NULL, naf VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE invoices (id INT NOT NULL, company_id INT DEFAULT NULL, invoices_number_id INT DEFAULT NULL, client_id INT DEFAULT NULL, last_payment_date DATE DEFAULT NULL, last_send_date DATE DEFAULT NULL, due_date DATE DEFAULT NULL, update_at DATE NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE invoices_number (id INT NOT NULL, invoice_number INT NOT NULL, PRIMARY KEY(id))');
